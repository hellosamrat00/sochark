...
export const posts: Post[] = [
    ...
    content: [
      ...
      { type: "h2", text: "Five fixes, ranked by effort" },
      {
        ...
        items: [
          ...
          "Right-size compute (1 week): most instances run under 20% utilization — drop a size or two and nothing changes but the invoice",
          "Schedule non-production (1 week): dev and staging don't need to run nights and weekends — that's 65% of the hours in a week",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "p",
        text: "Color, type, spacing, radius — as named tokens that exist in both Figma and code, generated from one source. When the brand shifts, you change one file. If your 'system' starts with a button library instead of tokens, it's a sticker pack.",
      },
